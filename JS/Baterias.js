document.addEventListener("DOMContentLoaded", function () {
  ...
  // JS migrado desde el <script> interno de Baterias.html

  // Indica si el usuario está logueado
  let isLoggedIn = false;

  // Bloquear acceso a enlaces de LogIn y formulario si no está logueado
  document
    .querySelectorAll('a.nav-link[href="Formulario.html"], a[href="carrito.html"]')
    .forEach((btn) => {
